...
import numpy as np
from ViT_Train import config, TumorDataset  # 假设vit_train.py包含数据集和配置
import timm
from torch.optim import Adam
from ViT_Train import train_loader, test_loader, valid_dataset
...
def main():
    ...
    model_path = 'model/ViT_epoch_15.pth'  # 替换为你的模型路径
